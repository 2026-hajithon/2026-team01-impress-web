    ...
    <div className="relative flex min-h-dvh flex-col">
      ...
      <div className="flex flex-1 flex-col gap-10 px-5 pt-6 pb-32">
        <div className="flex flex-col items-start gap-3">
          ...
          <p className="text-wrap-words w-full text-left text-head2-1 text-white">
            {prefixText}
            <br />
        ...
        <div className="flex flex-col gap-2.5">
          ...
          {answers.map((answer) => (
            ...
            >
              <p className="text-wrap-words text-left text-body2-2 text-gray-500">
                {answer.submitterName}
              </p>
              <p className="text-wrap-words text-left text-body1-1 text-white">
                {prefixText}
